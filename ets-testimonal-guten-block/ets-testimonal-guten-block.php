<?php
/*
* Plugin Name: Ets Testimonal Guten Block
* Plugin URI:  https://www.expresstechsoftwares.com/
* Description: Create custom block for gutenburg testimonal.
* Version: 1.0.0
* Author: Ruchita
* Requires at least: 5.4
* Text Domain: ets-testimonal
*/
function my_custom_block_register_block() {
	...
	// Register your block
	register_block_type( 'myguten-block/custom-testimonal-block', array(
